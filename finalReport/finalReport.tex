...
\begin{itemize}
	\item{Batch size, determines how many samples are at once, this is mainly limited by available memory}
	\item{Image size, the dimensions of the image, impacting detail perception and processing requirements}
	\item{In channels, depth of input data(RGB vs grayscale)}
	\item{Learning rate, how fast weights are updated during training}
	\item{Number of classes, the amount of classes the model can pick from}
\end{itemize}
