...
% \begin{figure}[h!]
% 	\centering
% 	\includegraphics[width=0.7\textwidth]{./images/mapGenBaselineHolesRT.png}
% 	\caption{Performance of the map generation algorithm with 10 points, 400 range, 3 holes}
% 	\label{PE:mg:baselineRTHoles}
% \end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{./images/mapGenBaselineMem.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{./images/mapGenPointsMem.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{./images/mapGenRangeMem.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{./images/mapGenHolesMem.png}
