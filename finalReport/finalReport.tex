...
Physically, the mower has 2 tracks on the sides of a metal frame, it is controlled by raspberry pi 4 running the Robot Operating System \citep{doi:10.1126/scirobotics.abm6074}.
Sensor wise, the robot is equipped with a GPS chip that was upgraded to RTK chip, 4G dongle and lidar.
